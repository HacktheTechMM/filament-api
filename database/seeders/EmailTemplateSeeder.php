    ...
    public function run() {
        $emailTemplates = [
            ...
            [
                ...
                'title'     => 'Mentorship Meeting Invitation',
                'subject'   => 'Meeting Invitation: ##subject## with ##mentor_name##',
                'preheader' => 'You have a new mentorship meeting scheduled',
                'content'   => "<p>Dear ##learner_name##,</p>
                    <p>You have been invited to a mentorship meeting with ##mentor_name## regarding the subject <strong>##subject##</strong>.</p>
                    <p><strong>Meeting Details:</strong></p>
                    <ul>
                        <li><strong>Mentor:</strong> ##mentor_name##</li>
                        <li><strong>Subject:</strong> ##subject##</li>
                        <li><strong>Requested Time:</strong> ##requested_time##</li>
                    </ul>
                    <p>You can join the meeting using the button below:</p>
                    <div>{{button url='##meeting_link##' title='Join Meeting'}}</div>
